...
xlswrite( [data_path,filesep,int2str(exp_num),filesep,'CSF_DGE_',cell2mat(method_name(method_num)),'.xls'],[time_min-base_time,dge_sig,time_min-base_time,s_fit]);
% Save fit parameters
smax = p_fit(:,1);
uin = p_fit(:,2);
save_path = [data_path,filesep,num2str(exp_num),filesep,'CSF_Smax_uin_R2_SNR_',cell2mat(method_name(method_num)),'.txt'];
